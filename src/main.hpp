...
uint16_t crawlerItem;

const std::map<uint16_t, ItemData> itemData
{
    {Item::buster,        {0, 0b0000'0001, "Buster"}},
    {Item::tornado,       {0, 0b0000'0010, "Tornado"}},
    {Item::claw,          {0, 0b0000'0100, "Claw"}},
    {Item::earthCrest,    {0, 0b0001'0000, "Earth crest"}},
    {Item::airCrest,      {0, 0b0010'0000, "Air Crest"}},
    {Item::waterCrest,    {0, 0b0100'0000, "Water Crest"}},

    {Item::crown,         {2, 0b0000'1000, "Crown"}},
    {Item::skull,         {2, 0b0001'0000, "Skull"}},

    {Item::hp1,           {3, 0b0000'0001, "Hp 1"}},
    {Item::hp2,           {3, 0b0000'0010, "Hp 2"}},
    {Item::hp3,           {3, 0b0000'0100, "Hp 3"}},
    {Item::hp5,           {3, 0b0001'0000, "Hp 5"}},
    {Item::hp7,           {3, 0b0100'0000, "Hp 7"}},
    {Item::hp9,           {4, 0b0000'0001, "Hp 9"}},
    {Item::hp10,          {4, 0b0000'0010, "Hp 10"}},
    {Item::hp14,          {4, 0b0010'0000, "Hp 14"}},

    {Item::stage1_Vellum, {5, 0b0000'0001, "Vellum (s1)"}},
    {Item::stage4_Vellum, {5, 0b0000'1000, "Vellum (s4)"}},
    {Item::stage1_Potion, {5, 0b0000'0010, "Potion (s1)"}},
    {Item::stage3_Potion, {5, 0b1000'0000, "Potion (s3)"}},
    {Item::stage4_Potion, {6, 0b0000'0001, "Potion (s4)"}},
};
...
const std::map<uint32_t, LocationData> locationData
{
    ...
    {Location::somulo,        {1, 0,        0, "Somulo"}}, //could see if somulo does a check just for fun
    {Location::hippogriff1,   {1, 0,   0x8123, "Hippogriff 1"}},
    {Location::arma1,         {1, 0,   0x8125, "Arma 1"}},

    {Location::stage2_Hp,     {0, 0,        0, "Stage 2 hp"}},
    {Location::belth,         {1, 0,   0x8127, "Belth"}},
    {Location::ovnunu,        {1, 1,        0, "Ovnunu"}}, //todo

    {Location::stage3_Potion, {0, 1,        0, "Stage 3 potion"}},
    {Location::stage3_Hp,     {0, 1,        0, "Stage 3 hp"}},
    {Location::skull,         {0, 1,        0, "Skull"}},
    {Location::flameLord,     {1, 1,   0x812B, "Flame Lord"}},

    {Location::stage4_Potion, {0, 1,        0, "Stage 4 potion"}},
    {Location::stage4_Vellum, {0, 1,        0, "Stage 4 vellum"}},
    {Location::crown,         {0, 0,        0, "Crown"}},
    {Location::flier,         {1, 0,   0x812D, "Flier"}},
    {Location::arma2,         {1, 0,   0x812F, "Arma 2"}},

    {Location::stage5_Hp1,    {0, 0,        0, "Stage 5 hp (1)"}},
    {Location::stage5_Hp2,    {0, 0,        0, "Stage 5 hp (2)"}},
    {Location::crawler,       {1, 0, 0x1FD5B1, "Crawler"}},
};
